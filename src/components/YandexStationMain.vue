...
<template>
  <div class="row d-flex justify-content-center nozzleMain-bg position-relative bg-white p-0 bg-info" style="height: 100vh">
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="yandexStationMain-box">
            ...
            <div class="mt-2 mt-lg-4 pt-4">
              <a href="https://rainboskin.me/umnaya_kolonka_rainbo" target="_blank" class="yandexStationMain-btn">Купить</a>
            </div>
          </div>
        </div>
      </div>
