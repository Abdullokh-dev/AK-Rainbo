...
.customize-playstation ._bold {
  font-weight: 700;
}

.customize-playstation ul {
  max-width: 560px;
  padding-left: 20px;
}

.customize-playstation ul svg {
  left: -20px;
  top: 10px;
}
